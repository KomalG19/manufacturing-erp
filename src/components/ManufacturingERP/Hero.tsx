...
<section className="py-16 bg-gray-50">
  <div className="max-w-6xl mx-auto px-6">
    <h2 className="text-3xl font-bold text-center">
      Best ERP Software in Pune for Smart Business Growth
    </h2>

    <p className="mt-6 text-lg text-gray-600 text-center">
      If you are looking for the best ERP software in Pune, our cloud-based ERP
      system is designed to help local businesses streamline operations,
      manage finances, track inventory, and improve productivity — all in one platform.
    </p>
  </div>
</section>
